...
<body style="background-color: white;">
	...
	<div class="wrapper">
		<div class="right"><br>
			<a href="users.php" style="margin-left:10px;"><button style="background-color: green; color: white; width: 250px;" class="btnlink">View Users</button></a><br>
			<?php
			...
			<center>
				...
				<input type="submit" value="Update" style="background-color: green; color: white; width: 250px;" class="btnlink" name="btn">
			</form>
			<?php 
			extract($_POST);
